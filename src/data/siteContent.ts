...
export const defaultContent: SiteContent = {
  profile: {
    ...
    ticker: [
      ...
      { id: 'ticker-1784885977638', text: { zh: 'MatchMeta AI 产品介绍', en: '', ko: '' }, image: '/assets/Recent/15e7909b72bc213f3513824f5fe6392-23w8k8mryscsww.jpg', imageHeight: 99 },
    ],
    headline: { zh: '<span style="font-size: 23px;">AI / LLM 专业背景 - AI Agent 产品/交互方向 - HAII 方式 - 前沿客户端侧工程</span><div><span style="font-size: 23px;">AI 语音交互 - TTS / ASR / VAD / KWS / 声学仿真 · 评测</span></div>', en: 'AI background, product design sense, research-driven project practice', ko: 'AI 전공 기반, 제품 디자인 감각, 연구 중심 프로젝트 경험' },
  ...
  skills: {
    ...
    groups: [
      ...
      { name: { zh: '开发 | 工程 | Vibe Codding', en: 'Product / Design', ko: '제품 / 디자인' }, items: ['Python', 'Linux', 'Docker', 'Git', 'LangChain', 'Workflow', 'RAG 评估/测评', 'vibe IDE/CLI 开发 - Claude Code | Codex | KIRO | Gemini&amp;Antigravity | Trae | Copilot | Windsurf | CodeBuddy', 'GitHub Pages', 'FDE'], theme: 'violet', itemColors: ['', '', '', '', '', '', '', '', '', ''] },
  ...
  timelineProjects: [
    {
      ...
      role: { zh: '端到端语音模块全链路涵 TTS、ASR、KWS、交互；<br><br>智能播报模块两大能力的从 0 到 1 设计与落地，覆盖「用户主动提问」与「系统主动播报」全场景；Memory流合并，覆盖用户主动提问与系统主动播报全场景。<br><br>覆盖交互设计、需求分析、技术选型、协议、链路搭建、前后端实现、测试模块开发与生产测试。', en: 'Led research framing, information hierarchy, visualization components, and insight writing.', ko: '리서치 프레임, 정보 계층, 시각화 컴포넌트, 인사이트 작성을 맡았습니다.' },
      outcome: { zh: 'TTS - 模型生成文本（被动/主动）做语音合成；涵 语音切片策略、交互流畅、TTS filler 方案、模型/声音选型、解耦原则<br><br><div>语音唤醒 - 设计三层半双工方案；设计RMS能量门——KWS|VAD——ASR<br><br></div><div>ASR - 自动（唤醒）/手动（按键）；涵 交互逻辑设计、模型/声音选型、测试平台搭建</div>', en: 'Helped the team identify user pain points faster and convert findings into design iteration directions.', ko: '팀이 사용자 문제를 더 빠르게 찾고 설계 개선 방향으로 전환하도록 도왔습니다.' },
      details: [
    ...
    },
    {
      ...
      details: [
        { zh: '语音前端：完成TEN/FSMN/Silero三类VAD算法横向评测与参数调优，建立延迟-误差量化评估体系，输出实时交互最优配置；完成27组极端RIR仿真与WPE去混响评估，验证RTF 0.45实时性与ΔSDR量化指标。', en: 'Positioned AI as assistance rather than replacement, preserving user control over learning rhythm.', ko: 'AI를 대체자가 아닌 보조자로 두어 사용자가 학습 리듬을 통제하도록 했습니다.' },
        { zh: '声学仿真：独立构建WebRIR-Studio在线仿真平台，实现RIR生成、卷积混音、2D/3D场景可视化一体化。', en: '', ko: '' },
        { zh: '模型评测：设计189条多场景打断识别测试样本，完成4款大模型对比实验，输出选型建议与对话策略优化方案。', en: '', ko: '' },
        { zh: '构建 SFT seed data 系统数据处理脚本，⾃动化处理覆盖 10k 原始语料与制作 100 条四态分布数据 策略，为机器⼈全双⼯对话系统奠定评估基准。对话数据：构建10k→100条论文级四态分布（Normal/RealINT/FakeINT/IncompleteQ）训练数据集。', en: '', ko: '' },
      ],
      widthPct: 100,
      imageHeight: 180,
      stackColors: ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
    },
    {
      ...
      role: { zh: '为跨国快消企业好丽友（中国）构建面向中韩双语用户的<span style="color: rgb(111, 215, 198);">人事制度智能问答助手</span>。<br><br>面向上海电气旗下集优机械轴承业务，构建<br><span style="color: rgb(111, 215, 198);">轴承垂直领域的工程智能体系统</span>。<br><br>面向光伏组件精密工业制造场景，设计并构建基于 RAG 的<span style="color: rgb(111, 215, 198);">工业设备运维对话助手</span>。', en: '负责内容', ko: '负责内容' },
      outcome: { zh: '完成三个B端智能体的原型设计：<br><br>好丽友人事智能体三路混合检索与7级权限隔离方案；<br>上海电气轴承智能体验证双通道检索与8个工程计算工具链交互；<br>晶澳运维智能体验证意图路由与图文混合文档解析方案。', en: '项目成果', ko: '项目成果' },
      details: [
        { zh: '项目1 - 好丽友（中国）：系统基于 LangGraph 构建多轮对话智能体，核心挑战在于跨国企业人事制度的复杂权限体系、多语言输入以及制度条款的精准溯源。', en: '', ko: '' },
        { zh: '项目2 - 上海电气上海集优机械：系统需同时处理非结构化工程知识（设计手册、标准规范）与结构化产品参数（型号、载荷、寿命数据等），实现知识问答、参数查询、工程计算、选型推荐与应用指导的一体化服务。', en: '', ko: '' },
        { zh: '项目3 - 晶澳太阳能：工业场景文档类型复杂（操作手册、保养手册、气路图、流程图），且对回答安全性与可控性要求极高，设计建立端到端的多格式文档处理与智能问答管线。', en: '', ko: '' },
        { zh: '注：相关图片均互联网获取与工作时合法环境下处理，原件未保留或传播，处理内容只做展示。', en: '', ko: '' },
      ],
      widthPct: 100,
      imageHeight: 170,
      stackColors: ['', '', '', '', '', '', '', '', ''],
  ...
  galleryProjects: [
    ...
    },
    {
      ...
      stack: ['Agent'],
      role: { zh: '针对大模型时效性知识滞后的核心痛点，设计基于 RAG + MCP 协议的实时新闻洞察 Agent，覆盖多源采集、智能摘要、事件关联分析，实现从单一API到混合数据源的自动化切换，实现新闻领域自动化跨平台检索。', en: '负责内容', ko: '负责内容' },
      result: { zh: '结合 Eax MCP Tool 实现新闻摘要生成、事件关联分析与趋势预测。完成端到端自动化流程构建，实现跨平台新闻检索、生成与分析一体化，通过引入 MCP 协议替换传统单一 API 调用，显著降低运维成本。', en: '项目成果', ko: '项目成果' },
      description: { zh: '项目描述', en: '项目描述', ko: '项目描述' },
      widthPct: 33.3,
      coverHeight: 180,
      hidden: false,
    ...
    },
    {
      ...
      title: { zh: 'NLP-基于BERT和TextCNN新闻标题分类', en: 'Academic Project 19', ko: '학술 프로젝트 19' },
    ...
    },
    {
      ...
      title: { zh: 'NLP-基于BERT和TextCNN新闻标题分类 (s2)', en: 'Academic Project 20', ko: '학술 프로젝트 20' },
    ...
    },
    {
      ...
      category: { zh: '学术驱动项目-23年', en: 'Academic Project', ko: '학술 기반 프로젝트' },
      notes: [
        { zh: '简介：创新点-传统心理问卷过于统一，难以准确反映每个学生的独特背景和需求。利用LLM技术，批量生成个性化与针对性心理问卷，可更好地了解学生心理状态。', en: '简介', ko: '简介' },
      ],
      stack: ['AI', 'Research'],
      role: { zh: '负责内容', en: '负责内容', ko: '负责内容' },
      result: { zh: '项目成果', en: '项目成果', ko: '项目成果' },
    ...
    },
    {
      ...
      category: { zh: '学术驱动项目-23年', en: 'Academic Project', ko: '학술 기반 프로젝트' },
      notes: [
        { zh: '简介：目标-基于背景信息动态生成高针对性的心理问卷；分析问卷回答，识别学生的心理特征、情绪、趋势和潜在问题；提供精准的评估与干预建议。', en: '简介', ko: '简介' },
      ],
      stack: ['AI', 'Research'],
      role: { zh: '负责内容', en: '负责内容', ko: '负责内容' },
      result: { zh: '项目成果', en: '项目成果', ko: '项目成果' },
    ...
    },
    {
      ...
      title: { zh: '生成式 AI 代码模型', en: 'Academic Project 24', ko: '학술 프로젝트 24' },
      cover: '/assets/PPT/ai-code-wsbaxgmrf89rrt.png',
      category: { zh: '学术驱动报告', en: 'Academic Project', ko: '학술 기반 프로젝트' },
      notes: [
        { zh: '简介：介绍了 Copilot、Code Llama 与 AlphaCode 三种生成式 AI 代码模型的技术原理、核心特性与应用场景差异，展示 Copilot 在实际编程中的使用案例。', en: '简介', ko: '简介' },
      ],
      stack: ['AI', 'Research'],
      role: { zh: '负责内容', en: '负责内容', ko: '负责内容' },
      result: { zh: '项目成果', en: '项目成果', ko: '项目成果' },
    ...
    },
    {
      ...
      title: { zh: '生成式 AI 音频模型', en: 'Academic Project 23', ko: '학술 프로젝트 23' },
      cover: '/assets/PPT/ai-osr5w9mrf89nig.png',
      category: { zh: '学术驱动报告', en: 'Academic Project', ko: '학술 기반 프로젝트' },
      notes: [
        { zh: '简介：系统介绍当时主流的AI语音/音乐生成工具及其技术特点、应用场景和未来趋势。涵盖语音合成、音乐生成和文档音频化的技术路线。', en: '简介', ko: '简介' },
      ],
      stack: ['AI', 'Research'],
      role: { zh: '负责内容', en: '负责内容', ko: '负责内容' },
      result: { zh: '项目成果', en: '项目成果', ko: '项目成果' },
    ...
    },
    {
      ...
      title: { zh: 'Ubuntu 系统信息收集脚本', en: 'Academic Project 18', ko: '학술 프로젝트 18' },
    ...
    },
    {
      ...
      title: { zh: '嵌入场景 基于YOLO的无人机目标检测与追踪系统', en: 'Academic Project 27', ko: '학술 프로젝트 27' },
    ...
    },
    {
      ...
      title: { zh: '针对老年人的专科医院选址 (s1)', en: 'Academic Project 25', ko: '학술 프로젝트 25' },
    ...
    },
    {
      ...
      title: { zh: '针对老年人的专科医院选址 (s2)', en: 'Academic Project 26', ko: '학술 프로젝트 26' },
  ...
  courses: [
    {
      ...
      title: { zh: '2022 2nd Semester', en: '新模块', ko: '新模块' },
      body: { zh: '<span style="color: rgb(111, 215, 198);">----------------------------------------</span>', en: '描述', ko: '描述' },
    ...
    },
    {
      ...
      title: { zh: '2023 1st Semester', en: '新模块', ko: '新模块' },
      body: { zh: '<span style="color: rgb(111, 215, 198);">----------------------------------------</span>', en: '描述', ko: '描述' },
    ...
    },
    {
      ...
      title: { zh: '2023 2nd Semester', en: '新模块', ko: '新模块' },
      body: { zh: '<span style="color: rgb(111, 215, 198);">----------------------------------------</span>', en: '描述', ko: '描述' },
    ...
    },
    {
      ...
      title: { zh: '2024 1st Semester', en: '新模块', ko: '新模块' },
      body: { zh: '<span style="color: rgb(255, 155, 155);">----------------------------------------</span>', en: '描述', ko: '描述' },
    ...
    },
    {
      ...
      title: { zh: '2024 2nd Semester', en: '新模块', ko: '新模块' },
      body: { zh: '<span style="color: rgb(255, 155, 155);">----------------------------------------</span>', en: '描述', ko: '描述' },
    ...
    },
    {
      ...
      title: { zh: '2025 1nd &amp; 2nd Semester', en: '新模块', ko: '新模块' },
      body: { zh: '<span style="color: rgb(255, 155, 155);">----------------------------------------</span>', en: '描述', ko: '描述' },
  ...
  major: [
    {
      id: 'ai-major',
      title: { zh: '<span style="color: rgb(109, 198, 243);">JJU</span> AI 介绍', en: 'Artificial Intelligence Background', ko: '인공지능 전공 배경' },
      body: { zh: '<span style="font-size: 0.85em;">‘韩国全州大学’ 人工智能系隶属于软件融合学院旗下。</span><div><span style="font-size: 0.85em;">全罗北道地区入选教育部“先进领域创新融合大学项目（人工智能领域）”的七所大学（系​​）之一。作为政府（教育部）指定的先进部门。</span></div><div><span style="font-size: 0.85em;">部门目标是培养具备第四次工业革命时代所需的专业人工智能知识和应用技能的创意人工智能专业人士。</span></div>', en: 'My academic background covers machine learning, deep learning, data structures, algorithms, and intelligent system applications. I aim to translate technical understanding into clear, aesthetic, and practical product expression.', ko: '전공 학습은 머신러닝, 딥러닝, 자료구조, 알고리즘, 지능형 시스템 응용을 포함합니다. 기술 이해를 명확하고 미감 있으며 실용적인 제품 표현으로 전환하고자 합니다.' },
    ...
    },
    {
      ...
      title: { zh: '<span style="color: rgb(155, 200, 228);">多伦多大学 UofT</span> - Mechanical &amp;e lndustrial Engineering | 维护优化与可靠性工程中心ML项目（C-MORE）', en: '新模块', ko: '新模块' },
      body: { zh: '<div><span style="font-size: 13.6px;">机器学习（ML）与强化学习（RL）领域的学术交流与专项学习。通过系统课程、实际项目实践及研讨会交流，探索强化学习技术在工业优化中的应用。</span></div><div><span style="font-size: 13.6px;">CHI-GUHN LEE PROFESSOR, MECHANICAL &amp; INDUSTRIAL DIRECTOR, C-MORE</span></div><div><span style="font-size: 13.6px;">Course dates : 2024(2M)</span></div>', en: '描述', ko: '描述' },
      tags: [],
    ...
    },
    {
      ...
      title: { zh: 'NVIDIA - 首尔科技大学', en: '新模块', ko: '新模块' },
      body: { zh: '基于 Transformer 的自然语言处理应用程序构建；LLM_NLP 培训<br>Certification lD: aFrzLsXdTk-mE7KTYuIYGQ', en: '描述', ko: '描述' },
      tags: [],
      images: [],
      imageHeight: 200,
      imagePos: [],
    ...
    },
    {
      ...
      title: { zh: 'AutoCar ⾃动驾驶比赛 - AI⿊客松⼀等奖&nbsp;', en: '新模块', ko: '新模块' },
      body: { zh: '韩国 Hanback Electronics 提供技术支持，实现自动驾驶车辆的自主导航与动态环境适应能力；获得“ AI 해커톤 AI를 활용한 auto Car 자율 주행 부문 「최우수상」', en: '描述', ko: '描述' },
      tags: [],
      images: [],
      imageHeight: 200,
      imagePos: [],
    ...
    },
    {
      ...
      title: { zh: '2023 世界⽆⼈机⾜球⼤赛 – 四强', en: '新模块', ko: '新模块' },
      body: { zh: '2023 第⼀届世界⽆⼈机⾜球⼤赛(FIDA World Championship)“KDSA University Division”&nbsp; <br>韩国高校组 - 四强 (首发)<br>', en: '描述', ko: '描述' },
      tags: [],
      images: [],
      imageHeight: 200,
      imagePos: [],
  ...
  recentResearch: [
    ...
    },
    {
      ...
      kind: '博客',
      title: { zh: 'SeedRealtime 音视频全双工大模型发布：走向全模态自然交互', en: '新条目', ko: '新条目' },
      link: '',
      note: { zh: 'SeedRealtime 用统一架构原生融合音频、视频与文本，能在连续的多模态信息流上实时交互，带来“边看、边听、边说”的全新体验。<br>三项核心突破：音视频联合理解、主动的交互能力、流畅的交互节奏。<br>项目主页：<span style="font-size: 0.86rem;">https://seed.bytedance.com/seedrealtime</span>', en: '', ko: '' },
    ...
    },
    {
      ...
      link: '',
      note: { zh: '本文由美团图灵Agent评测团队两年实战经验所得。<br><br><br><br>', en: '', ko: '' },
    ...
    },
    {
      ...
      note: { zh: '历时103天，MatchMate从一个实时AI看球Demo起步，逐步扩展到多比赛、语音、AI预测、玩法游戏，集线上互动和线下观赛为一体的AI辅助观赛综合体。<br><br>', en: '', ko: '' },
      image: '',
      pdf: '',
      imageMode: 'auto',
      imageHeight: 190,
    ...
    },
    {
      ...
      note: { zh: 'MatchMate AI看球搭子在世界杯期间和大家一起经历了许多迭代更新，包括语音唤醒、音色升级与线下第二现场等。将聊天转到了通话，将线上聚拢到了线下。从性能、玩法、细节上做了多处更新！<br><br>', en: '', ko: '' },
      image: '',
      pdf: '',
      imageMode: 'auto',
      imageHeight: 190,
    ...
    },
    {
      ...
      note: { zh: '本文提出GFT方法,从RL视角重新审视SFT训练,发现SFT本质上是一种奖励极度稀疏且重要性权重不稳定的RL形式。<br><br>', en: '', ko: '' },
      image: '',
      pdf: '',
      imageMode: 'auto',
      imageHeight: 190,
  ...
  sectionTitles: {
    ...
    "gallery": { zh: '学术驱动项目-个人', en: 'Academic Gallery', ko: '학술 갤러리' },
    "intro": { zh: '个人简介', en: 'Profile', ko: '소개' },
    "major": { zh: '专业背景与经历介绍', en: 'Major', ko: '전공' },
    "courses": { zh: '相关课程', en: 'Courses', ko: '수업' },
  },
  uiStrings: {
    ...
    "pillOutcome": { zh: '功能落地与验证', en: 'Outcome', ko: '결과' },
    "resumeView": { zh: '查看简历', en: 'View resume', ko: '이력서 보기' },
    "footNote": { zh: 'Vite + React · GitHub Pages / Vercel / Cloudflare Pages', en: 'Vite + React · GitHub Pages', ko: 'Vite + React · GitHub Pages' },
    "pillRole": { zh: '产品定位与设计', en: 'Role', ko: '역할' },
  },
  palette: '',
};