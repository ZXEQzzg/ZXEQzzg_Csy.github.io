  ...
  timelineProjects: [
    {
      ...
      title: { zh: 'MatchMate AI - 看球搭子（上海交通大学人工智能学院）<span style="color: rgb(111, 215, 198);">⚽︎</span>', en: 'Design Research Insight Dashboard', ko: '디자인 리서치 인사이트 대시보드' },
      period: '2026',
      summary: { zh: 'MatchMate · 足球 AI 搭子 —— 语音系统与智能播报模块产品设计/研发负责人<div>我们是来自上海交通大学人工智能学院的创业团队，MatchMate: AI 看球搭子 是我们打造一款<span style="color: rgb(255, 155, 155);">AI看球产品</span>，希望在信息爆炸、观点纷杂的媒体时代,能够借助AI的力量,把观众重新带回比赛本身。让每个人都能<span style="color: rgb(255, 155, 155);">边看边问</span>、<span style="color: rgb(255, 155, 155);">边看边懂</span>。<br>MatchMate 是一款<span style="color: rgb(255, 155, 155);">面向足球⚽︎观众的 实时 AI 陪伴与技术分析应用</span>，基于 SportMonks 实时数据/Zhibo8 事件流与大模型生成能力构建，为用户提供<span style="color: rgb(255, 155, 155);">赛前、赛中、赛后的个性化解说</span>，包含专业实时赛时数据、AI 数据预测、产品互动等多维度生态。我作为AI语音交互模块产品负责人，主导语音交互与赛场智能播报两大<span style="color: rgb(255, 155, 155);">「无手交互」能力的从0到1设计</span>，覆盖用户主动提问与系统主动播报全场景。</div>', en: 'Organized interviews, competitive research, and course feedback into traceable product decisions.', ko: '인터뷰, 경쟁 분석, 수업 피드백을 추적 가능한 제품 판단으로 정리했습니다.' },
      ...
      details: [
        ...
        { zh: '相关数据：103天 v1~v4版本、1727次代码提交、3倍新增用户、60w全网播放量、71%赛果预测准确率', en: '', ko: '' },
      ],
      widthPct: 100,
      imageHeight: 220,
      stackColors: ['', '', '', '', '', '', '', '', '', '', '', ''],
