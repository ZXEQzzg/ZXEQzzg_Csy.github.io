...
export const defaultContent: SiteContent = {
  profile: {
    ...
    ticker: [
      { id: 'ticker-1783715176788', text: { zh: '“你好搭子” 最新更新 KWS模块', en: '', ko: '' }, image: '/assets/Recent/hidazi-x6o2hpmrfdznnn.png', imageHeight: 81 },
      ...
      { id: 'ticker-1783715737567', text: { zh: 'MatchMeta AI', en: '', ko: '' }, image: '/assets/Recent/fc89fd0fe754202699f1550be8a7d87-w7hr0emrfeb5kf.jpg', imageHeight: 99 },
    ],
    headline: { zh: '<span style="font-size: 23px;">AI / LLM 专业背景 - AI Agent 产品方向 - HAII 方式</span><div><span style="font-size: 23px;">AI 语音交互（ TTS / ASR / VAD / KWS / 声学仿真 ）</span></div>', en: 'AI background, product design sense, research-driven project practice', ko: 'AI 전공 기반, 제품 디자인 감각, 연구 중심 프로젝트 경험' },
    ...
    research: { zh: '<span style="font-size: 0.85em;"><b><span style="color: rgb(242, 196, 109);">研究方向</span>：</b>Agent 多领域应用 | Agent Memory | 语音（TTS/ASR/VAD/KWS/声学SIM）| LLM 全双工语音交互 | Agent HCI&nbsp;</span><div><span style="font-size: 0.85em;"><b><span style="color: rgb(242, 196, 109);">工程具备</span>：</b>AI 工程方式的前沿技术 | Agent与语音交互方式 | 快速搭建原型流 | 用户需求分析 | 技术交互类产品研究</span></div>', en: 'Research interests: multimodal interaction, agentic applications, AI-assisted design, and data-driven product analysis.', ko: '연구 관심사: 멀티모달 인터랙션, 에이전트 애플리케이션, AI 보조 디자인, 데이터 기반 제품 분석.' },
  ...
  skills: {
    ...
    groups: [
      ...
      { name: { zh: '开发 | 工程 | Vibe Codding', en: 'Product / Design', ko: '제품 / 디자인' }, items: ['Python', 'Linux', 'DoAcker', 'Git', 'LangChain', 'Workflow', 'RAG 评估/测评', 'vibe IDE/CLI 开发 - Claude Code | Codex | KIRO | Gemini&amp;Antigravity | Trae | Copilot | Windsurf | CodeBuddy', 'GitHub Pages'], theme: 'violet', itemColors: ['', '', '', '', '', '', '', '', ''] },
  ...
  timelineProjects: [
    ...
    },
    {
      ...
      period: '2026',
      summary: { zh: '智能体设计 | To B 垂类 Agent/RAG 产品原型开发 | bizfocus 是一家专注于企业级AI/IT技术服务与数字化转型的高新技术企业。帮助企业将大模型与智能体能力真正接入业务流程、系统与企业知识。<br><div>本人主要负责面向B端企业客户的智能体产品原型开发与智能体架构设计。工作覆盖从需求分析、数据方案与处理、检索架构设计、工具链选型到多轮对话状态管理链路，参与基于 LangGraph / LangChain / LlamaIndex / Dify 的企业级 Agentic RAG 系统构建。</div>', en: '项目简介', ko: '项目简介' },
